...
HUMANIZER_MODEL_ID = os.getenv("HUMANIZER_MODEL_ID", "mistralai/ministral-3b-2512")
HUMANIZER_AUDIT_MODEL_ID = os.getenv("HUMANIZER_AUDIT_MODEL_ID", "openai/gpt-5-mini")
HUMANIZER_FALLBACK_MODELS = os.getenv("HUMANIZER_FALLBACK_MODELS", "")
HUMANIZER_SENTENCE_BATCH_SIZE = int(os.getenv("HUMANIZER_SENTENCE_BATCH_SIZE", "8"))
HUMANIZER_MAX_CONCURRENCY = int(os.getenv("HUMANIZER_MAX_CONCURRENCY", "6"))
HUMANIZER_REQUEST_TIMEOUT = float(os.getenv("HUMANIZER_REQUEST_TIMEOUT", "30"))
HUMANIZER_MAX_RETRIES = int(os.getenv("HUMANIZER_MAX_RETRIES", "2"))
HUMANIZER_PROVIDER_SORT = os.getenv("HUMANIZER_PROVIDER_SORT", "throughput").strip().lower()
HUMANIZER_DEFAULT_STRENGTH = int(os.getenv("HUMANIZER_DEFAULT_STRENGTH", "8"))
...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://byinfini.online',
    'https://www.byinfini.online',
    'http://localhost:8000',
    'http://127.0.0.1:8000',
    'http://localhost:8001',
    'http://127.0.0.1:8001',
