...
HUMANIZER_MODEL_ID = os.getenv("HUMANIZER_MODEL_ID", "qwen/qwen3.7-flash")
HUMANIZER_FALLBACK_MODELS = os.getenv("HUMANIZER_FALLBACK_MODELS", "qwen/qwen3.5-9b,deepseek/deepseek-flash-latest")
