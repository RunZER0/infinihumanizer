...
ARTICLES = [
    ...
    },
    {
        ...
        "body": [
            ...
            """I also look at line breaks. A headline may have been written for a dramatic two-line desktop composition, then become an awkward stack of isolated words on mobile. That is not a CSS problem alone. Sometimes the sentence needs to change. A shorter verb can restore the rhythm. A noun can move earlier so the first two lines carry meaning even before the rest is seen.""",
    ...
    {
        "slug": "you-can-hear-when-a-company-does-not-know-its-customer",
        "title": "You can hear when a company does not know its customer",
        "date": date(2026, 6, 28),
        ...
        "body": [
            ...
            """Customer knowledge is not the same as knowing demographics. Age, location, job title, and industry can be useful. I care more about the words people use when they are frustrated, uncertain, comparing options, or explaining the task to a colleague. Those sentences contain the real buying context. They tell you what feels urgent, what needs proof, and what the person is afraid of getting wrong.""",
            """This matters in AI products because teams often describe the model instead of the work. A user may not care that a system uses retrieval, orchestration, or a particular model family. They care whether it can read their documents, keep citations attached to claims, and return something they can use. Technical detail belongs where it helps evaluation. It should not replace the customer’s problem in the main message.""",
            """I also distrust audience copy that tries to sound familiar through slang. Knowing a customer does not mean copying their informal speech. It means understanding their level of knowledge and respecting their time. A lawyer and a product manager can both prefer simple English. Simplicity does not require pretending they speak the same professional language.""",
    ...
    },
    {
        ...
        "body": [
            """I am suspicious of copy that wants every sentence to sell. You can feel the pressure in phrases such as “transform your workflow,” “unlock unmatched value,” or “revolutionize the way you work.” The problem is not that these claims are always false. The problem is that they ask the reader to accept a conclusion before the page has shown enough evidence.""",
            """Persuasion works better when the writing understands sequence. First establish the situation accurately. Then show what changes. Give the reader enough detail to judge whether the change matters to them. A strong offer becomes persuasive through relevance and proof. It does not need emotional volume on every line.""",
    ...
    },
    {
        ...
        "body": [
            ...
            """I do not think good writing needs to hide the use of AI. That is the wrong target. The target is writing that has been judged. Someone has decided what matters, what can be cut, where the tone should tighten, and where detail is worth the space. AI can produce material quickly. Editorial judgment gives the material a shape worth keeping."""
        ],
    },
    {
        ...
        "body": [
            """UX writing has an unusual success condition: people often do not notice it when it works. They notice the product. They finish the task. The words quietly explain the next action, the current state, and any consequence that deserves attention. That invisibility is earned through careful choices.""",
            """I do not mean that interface language should have no personality. Personality can help a product feel coherent. The problem begins when personality competes with the task. An error message is a bad place for a joke if the user has just lost work. A payment failure does not need a clever metaphor. It needs the reason, what happened to the money, and what the person can do next.""",
    ...
    },
    {
        ...
        "date": date(2026, 2, 18),
        "dek": "Research is not a pile of facts handed to a writer. It changes what the writer is willing to claim.",
        "body": [
            ...
            """Writing is useful because it exposes what the research has not settled. A bullet point can hide uncertainty. A paragraph cannot hide it as easily because the relationships between ideas have to be stated. Who caused what? Compared with when? Under which conditions? When the sentence becomes awkward, the underlying evidence is often awkward too.""",
    ...
    },
    {
        ...
        "body": [
            ...
            """Mobile copy benefits from stronger nouns and verbs because space is expensive. This does not mean making every sentence short. It means removing setup that relies on visual room. A precise sentence can be long and still work well on a phone if the information arrives in the right order.""",
            """The phone is not a secondary version of the site. For many people it is the site. I think copy should be approved there with the same seriousness as the desktop composition. If the words only work at 1440 pixels, the writing is unfinished."""
        ],
    },
    {
        ...
        "date": date(2025, 11, 7),
        "dek": "Clear writing is essential, but clarity alone does not give a company a voice.",
        "body": [
            ...
            """I prefer a sentence that could only belong to one company. That does not require cleverness. It may simply contain a detail competitors would avoid, a limitation stated plainly, or a point of view about how the work should be done. Distinction often comes from being willing to say something narrower than the market category.""",
